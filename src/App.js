    ...
    async function fetchData() {
      try {
        const [cartResponse, favoritesResponse, itemsResponse] =
          await Promise.all([
            axios.get("https://638f2c579cbdb0dbe31f1e52.mockapi.io/cart"),
            axios.get("https://638f2c579cbdb0dbe31f1e52.mockapi.io/favorites"),
            axios.get("https://638f2c579cbdb0dbe31f1e52.mockapi.io/items"),
          ]);
  ...
  const onAddToCart = async (obj) => {
    try {
      ...
      if (findItem) {
        ...
        await axios.delete(
          `https://638f2c579cbdb0dbe31f1e52.mockapi.io/cart/${findItem.id}`
        );
      } else {
        const { data } = await axios.post(
    ...
    >
      <div className="wrapper clear">
        ...
        <Routes>
          ...
          <Route
            path="/orders"
            element={<Orders items={favorites} onAddToCart={onAddToCart} />}
          />
        </Routes>
      </div>
    </AppContext.Provider>
